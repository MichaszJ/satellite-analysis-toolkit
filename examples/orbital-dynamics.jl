...
# ╔═╡ fc582a62-d2a2-11ed-1bb0-01444c7aa5b9
using Plots, ModelingToolkit, DifferentialEquations, Unitful

# ╔═╡ 40a22ab4-c158-4720-a38e-9682d002b34a
include("../src/TwoBody.jl")

# ╔═╡ 2cc042ca-b586-46b4-b581-170e65add313
ModelingToolkit.validate(two_body_equations)

# ╔═╡ 5ec94b2c-5117-45a1-89a4-d85e5617b813
...
# ╔═╡ 7712a9a3-d9da-4924-ac2b-b15bf30f7427
u₀ = Dict(
	x₁ => 0.0u"m",
	y₁ => 0.0u"m",
	z₁ => 0.0u"m",
...
# ╔═╡ a38c0cb2-10cf-465b-b8f4-95341c274816
p = Dict(
	G => G_val,
	m₁ => 10e26u"kg",
	m₂ => 10e26u"kg"
...
# ╔═╡ e48bbc11-6920-45f8-b4a8-fd78cfc653a8
tspan = (0.0, 480.0)

# ╔═╡ cfb78e1e-711b-41f7-8682-7e665e413f44
...
# ╔═╡ 2d203413-8124-4009-b671-5f2a6551679b
two_body_sol = solve(two_body_problem, Tsit5())

# ╔═╡ 3e7d5887-21d2-4bce-a037-94dd734ebf6a
times = 0.0:0.01:480.0

# ╔═╡ 7e10e4ac-8000-432a-aecb-02e1662e6216
interp = two_body_sol(times);

# ╔═╡ 6cdb630d-68d8-4b72-9c5a-37a2fd6439ed
begin
	plot(
...
# ╔═╡ fd174e5c-626f-4af9-a752-0491700be810
typeof(interp[x₁][2])
...
julia_version = "1.8.2"
manifest_format = "2.0"
project_hash = "00175d3bd818d214d3bfd13b2061ad3738ab351c"
...
git-tree-sha1 = "70cd987c6383d5cd187b2180cd655c5a30799332"
